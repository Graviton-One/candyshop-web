<template>
  ...
  @close="$store.commit('app/CLOSE_MODAL')">
    <div class="relative h-full bg-white rounded-[8px] min-h-[307px] py-[44px] px-[40px] sm:w-[540px]">
      ...
      <div class="flex rainbow rounded-[23px] justify-center">
        <div class="bg-dark-charcoal rounded-[10px] min-h-[215px] flex flex-col justify-center items-center">
          <img class="w-[80px] h-[80px] object-center object-contain mb-[30px]" src="~/assets/img/interface/congratulations.svg" :alt="label">
